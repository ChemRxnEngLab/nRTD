...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 18 16:55:35 2024
...
def process_data(file_num, ax):
    x_file_path = PWD / f"TOA_MGA_20231020_010_{file_num:06d}_x_processed.npy"
    t_file_path = PWD / f"TOA_MGA_20231020_010_{file_num:06d}_t_processed.npy"
