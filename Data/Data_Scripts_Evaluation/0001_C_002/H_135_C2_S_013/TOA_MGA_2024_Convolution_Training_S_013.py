...
c_in[::2, :, t_input > 1] = 1.44
c_in[1::2, :, t_input < 1] = 1.44
...
for file_num in file_numbers:
    ...
    try:
        ...
        c_out = torch.tensor(np.load(c_out_path), dtype=torch.float32).unsqueeze(0).unsqueeze(0)*42.73
...
plt.plot(t_input, c_in[0, 0, :].numpy(), label="$C_{in,2}$", color="blue")
...
plt.savefig("Figure_001_S_013_REPORT_001", dpi=300)