...
c_in[::2, :, t_input > 1] = 3.2
c_in[1::2, :, t_input < 1] = 3.2
...
for file_num in file_numbers:
     ...
     #     continue
    t_conv_path = f"/Users/tuanaoyuncu/Documents/GitHub/nRTD/Data/0003/C_004_0003/H_130_C4_0003/S_039/TOA_MGA_20240228_0039_{file_num:03d}_t_processed.npy"
    # t_conv_path = f"Data/C_001/H_085_C1/S_009_C1/TOA_MGA_20231020_009_{file_num:06d}_t_processed.npy"
    c_out_path = f"/Users/tuanaoyuncu/Documents/GitHub/nRTD/Data/0003/C_004_0003/H_130_C4_0003/S_039/TOA_MGA_20240228_0039_{file_num:03d}_x_processed.npy"
    ...
    try:
        ...
        c_out = torch.tensor(np.load(c_out_path), dtype=torch.float32).unsqueeze(0).unsqueeze(0)*48.3
...
plt.savefig("Figure_001_REPORT_001", dpi=300)