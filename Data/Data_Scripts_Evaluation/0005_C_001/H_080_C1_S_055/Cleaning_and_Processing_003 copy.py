...
def process_data(file_num):
    ...
    x_file_path = DATA / "0005" / "C_001" / "H_080_C1" / "S_055_C1" / f"TOA_MGA_20240701_0055_{file_num:06d}_x.npy"
    t_file_path = DATA / "0005" / "C_001" / "H_080_C1" / "S_055_C1" / f"TOA_MGA_20240701_0055_{file_num:06d}_t.npy"
    ...
    # Save processed data
    np.save(DATA / "0005" / "C_001" / "H_080_C1" / "S_055_C1" / f"TOA_MGA_20240701_0055_{file_num:06d}_t_processed.npy", t_pretty)
    np.save(DATA / "0005" / "C_001" / "H_080_C1" / "S_055_C1" / f"TOA_MGA_20240701_0055_{file_num:06d}_x_processed.npy", x_evel)
...
def main():
    ...
    # plt.xlabel()
    # plt.ylabel()
    plt.savefig("Figure_001_S_055", dpi=300)
    plt.show()
