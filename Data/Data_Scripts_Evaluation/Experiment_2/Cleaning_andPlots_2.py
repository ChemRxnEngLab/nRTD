...
def process_data(file_num):
    ...
    x_file_path = DATA / "C_002" / "H_185_C2" / "S_014_C2" / f"TOA_MGA_20231020_014_{file_num:06d}_x.npy"
    t_file_path = DATA / "C_002" / "H_185_C2" / "S_014_C2" / f"TOA_MGA_20231020_014_{file_num:06d}_t.npy"
    ...
    # Save processed data
    np.save(DATA / "C_002" / "H_185_C2" / "S_014_C2" / f"TOA_MGA_20231020_014_{file_num:06d}_t_processed.npy", t_pretty)
    np.save(DATA / "C_002" / "H_185_C2" / "S_014_C2" / f"TOA_MGA_20231020_014_{file_num:06d}_x_processed.npy", x_evel)
