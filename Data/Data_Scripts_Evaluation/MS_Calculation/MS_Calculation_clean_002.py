...
def main():
    ...
    folder = data_folder / "0003" / "C_003_0003" / "H_080_C3_0003" / "S_035"
    print(folder.is_dir())
    
    # Define the absolute path to the calibration file
    calibration_file = data_folder / "0003" / "C_001_0003" / "H_080_C1_0003" / "S_035" / "010_0Ar_010_0He_080_0H2_otherdescription.asc"
