...
data_cap.setup("fit")
data_cap.x = data_cap.x[::4, ...]
data_cap.t_in = data_cap.t_in[::4, ...]
data_cap.y = data_cap.y[::4, ...]
...
data_reac_inlet.x = data_reac_inlet.x[::4, ...]
data_reac_inlet.t_in = data_reac_inlet.t_in[::4, ...]
data_reac_inlet.y = data_reac_inlet.y[::4, ...]
...
data_reac_outlet.x = data_reac_outlet.x[::4, ...]
data_reac_outlet.t_in = data_reac_outlet.t_in[::4, ...]
data_reac_outlet.y = data_reac_outlet.y[::4, ...]
...
data_total_system.x = data_total_system.x[::4, ...]
data_total_system.t_in = data_total_system.t_in[::4, ...]
data_total_system.y = data_total_system.y[::4, ...]
