...
def process_data(file_num):
    ...
    # Save processed data
    np.save(PWD / f"TOA_MGA_20231020_012_{file_num:06d}_t_processed_conc_377.npy", t_pretty)
    np.save(PWD / f"TOA_MGA_20231020_012_{file_num:06d}_x_processed_conc_377.npy", x_evel)
