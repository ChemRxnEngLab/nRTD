...
def process_data(file_num):
    ...
    # print(t_start)
    # print(t_end_2)
    t_evel = np.linspace(t_start, t_end, 200)
    ...
    # Save processed data
    np.save(PWD / f"TOA_MGA_20231020_010_{file_num:06d}_t_processed_2nd_Layer_conc_norm_tevel.npy", t_pretty)
    np.save(PWD / f"TOA_MGA_20231020_010_{file_num:06d}_x_processed_2nd_Layer_conc_norm_tevel.npy", x_evel)
