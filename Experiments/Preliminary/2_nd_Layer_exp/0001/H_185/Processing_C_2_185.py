...
def process_data(file_num):
    ...
    # Save processed data
    np.save(PWD / f"TOA_MGA_20231020_014_{file_num:06d}_t_processed_norm.npy", t_pretty)
    np.save(PWD / f"TOA_MGA_20231020_014_{file_num:06d}_x_processed_norm.npy", x_evel)
