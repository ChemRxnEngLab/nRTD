...
c_out_l_a_in_full = np.convolve(c_0_l_a_in, E_laminar_a_in / np.sum(E_laminar_a_in), mode="full")
t_conv_l_a_in_full = np.linspace(t_l_a_in[0] + t_l_a_in[0], t_l_a_in[-1] + t_l_a_in[-1], len(c_out_l_a_in_full))
...
for result in results_out:
    ...
    if E_Adler_out.shape[0] != t_values_Adler_out.shape[0]:
        if E_Adler_out.shape[0] > t_values_Adler_out.shape[0]:
            ...
            E_Adler_out = np.pad(E_Adler_out, (0, len(t_values_Adler_out) - len(E_Adler_out)), 'constant')
...
c_out_l_a_out_full = np.convolve(c_0_l_a_out, E_laminar_a_out / np.sum(E_laminar_a_out), mode="full")
t_conv_l_a_out_full = np.linspace(t_l_a_out[0] + t_l_a_out[0], t_l_a_out[-1] + t_l_a_out[-1], len(c_out_l_a_out_full))
...
t_conv_full_Adler_out = np.linspace(t_values_Adler_out[0] + t_values_Adler_out[0], t_values_Adler_out[-1] +t_values_Adler_out[-1], len(c_out_full_Adler_out))
