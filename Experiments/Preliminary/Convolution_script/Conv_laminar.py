...
tau_1_dir = '/Users/tuanaoyuncu/Documents/GitHub/nRTD/Experiments/Preliminary/Litrature/Laminar_Flow_Model/tau_1.00'


t_conv_tau1 = torch.tensor(np.load(os.path.join(tau_1_dir, 'time.npy')), dtype=torch.float32).unsqueeze(0).unsqueeze(0)
c_out_tau1 = torch.tensor(np.load(os.path.join(tau_1_dir, 'concentration.npy')), dtype=torch.float32).unsqueeze(0).unsqueeze(0)
...
c_out_list.append(c_out_tau1)
t_conv_list.append(t_conv_tau1)
