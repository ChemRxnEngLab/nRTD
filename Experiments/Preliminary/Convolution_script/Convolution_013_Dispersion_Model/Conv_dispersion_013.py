...
tau_5_dir = '/Users/tuanaoyuncu/Documents/GitHub/nRTD/Experiments/Preliminary/Litrature/Dispersion_Model/Bo10'
...
n_disc = 200
t_input = torch.linspace(0, 60, n_disc)
...
plt.savefig("Figure_conv_dispersion_Bo10")
plt.show()
