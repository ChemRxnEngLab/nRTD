...
plt.plot(t_input_np, c_conv_np, label="Model Output (c_conv)", color="red", linestyle="--")
plt.plot(t_input_np, c_conv_fitted, label="Fitted Curve", color="green")
plt.plot(t_E_np, E_np, label="E (Model Output)", color="orange")
plt.plot(t_E_np, E_expected_np, label="E (Expected Formula)", color="purple", linestyle="--")
plt.xlim((0, 40))
plt.ylim((0, 1.1))
plt.xlabel("Time")
plt.ylabel("Concentration")
plt.legend()
plt.title("Model Output vs. Input Concentration")
plt.show()
