...
unified_dir = os.path.join(save_dir, f'Bo_{3}_2711')
...
np.save(os.path.join(unified_dir, 'c_conv_in_Bo_3.npy'),c_conv_in_50 )
...
current_date = datetime.datetime.now().strftime("%Y%m%d")
plt.savefig(os.path.join(save_dir,f"Profile_Bo3{current_date}.png"), dpi=300)
plt.show()
