...
adler_dir=r"d:\Tuana\nRTD\Experiments\Preliminary\Litrature\Adler_havarka_Model\tau_a_val_1_tau_p_val_2_tau_m_val_0.4000000000000001_beta_val_0.1_100"
epoch=1
...
t_conv_tau = torch.tensor(np.load(os.path.join(adler_dir, 'time_100_300.npy')), dtype=torch.float32).unsqueeze(0).unsqueeze(0)
c_out_tau = torch.tensor(np.load(os.path.join(adler_dir, 'concentration_100_300.npy')), dtype=torch.float32).unsqueeze(0).unsqueeze(0)
n_disc = n_in_1
