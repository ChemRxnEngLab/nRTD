...
adler_dir = '/Users/tuanaoyuncu/Documents/GitHub/nRTD/Experiments/Preliminary/Litrature/Adler_havarka_Model/tau_a_val_3_tau_p_val_2_tau_m_val_0.4000000000000001_beta_val_0.1_2110'
epoch=15000
...
plt.savefig(f"Figure_plot_tau_3_adler{current_date}.png", dpi=300)
plt.show()
...
plt.plot(t_E, E, label='$E_{CNN,adl}$,$tau_a=3$', color="red")
...
current_date = datetime.datetime.now().strftime("%Y%m%d")
plt.savefig(f"E_tau_3_adler_{current_date}.png", dpi=300)
plt.show()
