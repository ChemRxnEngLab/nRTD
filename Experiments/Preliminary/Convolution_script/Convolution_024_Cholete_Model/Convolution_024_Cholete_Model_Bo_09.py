...
Bo_dir = r'D:\Tuana\nRTD\Experiments\Preliminary\Litrature\Cholete_Model\beta0.9_n'
...
ax2.plot(t_conv_e, E_c_e_normalized/E_c_e_normalized.max(), label="E", color="red",linestyle="--")
