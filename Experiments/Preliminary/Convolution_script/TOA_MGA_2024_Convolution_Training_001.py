...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 29 23:32:06 2024
...
c_in = torch.zeros((10, 1, n_disc))#do not forget to check the sizes when you will load the the rest
c_in[::2, :, t_input > 1] = 0.05
c_in[1::2, :, t_input < 1] = 0.05
file_numbers = range(1, 21,2)#for odd folders
c_out_list = []
t_conv_list = []
...
for i, file_num in enumerate(file_numbers):
   ...
   # c_out_path = f"Data/C_001/H_085_C1/S_009_C1/TOA_MGA_20231020_009_{file_num:06d}_x_processed.npy"
    print(f"Loaded files: {t_conv_path}, {c_out_path}")#I added to see the files that I load
...
print(f"Loaded c_out size: {c_out.size()}")
