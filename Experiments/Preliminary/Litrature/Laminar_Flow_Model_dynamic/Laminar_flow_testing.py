...
np.save(os.path.join(base_dir, 'time_test.npy'), t_conv)
np.save(os.path.join(base_dir, 'concentration_test.npy'), c_out)
np.save(os.path.join(base_dir, 'input_test.npy'), c_0_1)
