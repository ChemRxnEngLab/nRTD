...
#     xlabel=[r"$t$ / $s$", r"$t$ / $s$"], 
#     ylabel=[
#         [r"$x$ / $1$", r"$E$ / $1$"],   [r"$x$ / $1$", r"$E$ / $1$"],[r"$x$ / $1$", r"$E$ / $1$"]
#     ])
...
# axs[0, 1].plot(
#     predicted_time,  # Ensure this is also 1D
#     expected_E, label=r"$E(t)$", color=ICIWcolors.KELLYGREEN
# )
# axs[0, 1].plot(
#     predicted_time,  # Ensure this is also 1D
#     predicted_E,label=r"$\hat{E}(t)$", color="black", linestyle="--"
# )
# axs[0, 0].set_xlim((0, 30)) 
# axs[0, 1].set_xlim((0, 20)) 
# ####
...
#     predicted_time_Bo_1,  # Ensure this is also 1D
#     expected_E_Bo_1,
# label=r"$E(t)$", color=ICIWcolors.KELLYGREEN
# )

# axs[1, 1].plot(
#     predicted_time_Bo_1,  # Ensure this is also 1D
#     predicted_E_Bo_1,
# label=r"$\hat{E}(t)$", color="black", linestyle="--"
# )
